...
CREATE TABLE IF NOT EXISTS `colaboradores` (
  ...
  `cargo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
...
-- Volcando datos para la tabla elmesonicea.colaboradores: ~0 rows (aproximadamente)
INSERT INTO `colaboradores` (`id`, `nombre`, `cargo`, `descripcion`, `telefono`, `foto_perfil`, `activo`, `fecha_registro`) VALUES
	(1, 'Obed Castro', 'Administrador de TI', 'Descripción del colaborador Obed Castro, quien es el administrador de TI, para mostrar en el sitio web de Iglesia El Mesón ICEA.', '000000000', 'perfil_01.jpg', 0, '2026-01-23 19:57:32'),
	(2, 'Alberto Orellana', 'Técnico de soporte', 'Somos un equipo unido por la fe y el amor de Dios. Servimos con humildad, compromiso y pasión. Nuestro propósito es edificar vidas y compartir esperanza.', '121212121212', 'alberto_orellana-1769207178.png', 0, '2026-01-23 22:26:18');
...
INSERT INTO `declaraciones_de_fe` (`id`, `numero`, `titulo`, `descripcion`, `versiculo`, `activo`, `fecha_creacion`) VALUES
	(1, '9', 'Primera declaración de fe', 'Descripción de primera declaración de fe', 'Versículo 12:33', 1, '2026-01-21 22:13:32'),
	(4, '1', 'Primera declaración de fe', 'Esta es la descripción de la primera declaración de fe', 'verso 12:12', 1, '2026-01-23 15:09:16');
...
-- Volcando datos para la tabla elmesonicea.nuestros_pilares: ~0 rows (aproximadamente)
INSERT INTO `nuestros_pilares` (`id`, `titulo`, `descripcion`, `activo`, `fecha_registro`) VALUES
	...
	(8, 'aaaa', 'sdflh lasd lsba lvajsbd lfjbasdl fadsf', 0, '2026-01-23 21:05:05'),
	(9, 'asdsadg', 'sadgsdgasgag', 0, '2026-01-23 21:05:30'),
	(10, 'qwqwqw', 'fdgfmjdghjsfgjsjhsgdj', 0, '2026-01-23 21:05:39'),
	(11, 'Ejemplo de pilares', 'Es necesario contemplar el tamaño de estos elementos, para no distorsionar el dom.', 1, '2026-01-23 21:09:39');
...
-- Volcando datos para la tabla elmesonicea.nuestros_valores: ~0 rows (aproximadamente)
INSERT INTO `nuestros_valores` (`id`, `titulo`, `descripcion`, `activo`, `fecha_registro`) VALUES
	...
	(3, 'Adoración', 'En espíritu y en verdad" (Juan 4:24). Descripción: Vivimos una vida rendida a Dios, no solo en palabras, sino en obediencia diaria.', 1, '2026-01-23 17:09:20'),
	(4, 'Adoración', 'En espíritu y en verdad" (Juan 4:24). Descripción: Vivimos una vida rendida a Dios, no solo en palabras, sino en obediencia diaria.', 1, '2026-01-23 17:09:20'),
	(5, 'Adoración', 'En espíritu y en verdad" (Juan 4:24). Descripción: Vivimos una vida rendida a Dios, no solo en palabras, sino en obediencia diaria.', 1, '2026-01-23 17:09:20'),
	(6, 'Adoración', 'En espíritu y en verdad" (Juan 4:24). Descripción: Vivimos una vida rendida a Dios, no solo en palabras, sino en obediencia diaria.', 1, '2026-01-23 17:09:20'),
	(9, 'ccccccc', 'cccccccc aksjdl asdf sadfuish fshafdihas fiñsadhfñisadhfñ saifhañwfiehewñifhas ñfiashfliuahfl asufglas fuigsalf usagf lsugfl asufadsf', 0, '2026-01-23 17:52:10'),
	(11, 'asasasas', 'asassa asas s as as as a s sadgsg dh dh dfh dfhdfh dfh dh d', 0, '2026-01-23 20:59:45');
